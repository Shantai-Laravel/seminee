...
<body>
    <div class="email-container">
        ...
        <p>
            {{ trans('vars.Email-templates.subjectOrderEmail') }} <a href="https://juliaallert.com">juliaallert.com</a>
        </p>
        <p>
            {{ trans('vars.Email-templates.emailOrderBodyTrackingLink') }} <a href="https://juliaallert.com/en/account/history">juliaallert.com/en/account/history</a>
        </p>
        <div class="gift">
        ...
        <a href="https://juliaallert.com" class="butt">{{ trans('vars.Auth.login') }}</a>

        <p class="miss">
            {{ trans('vars.Email-templates.emailBodyNewInOutlet') }}
        </p>
        <div class="buttGroups">
            <a href="https://juliaallert.com/en/new" class="butt">{{ trans('vars.PagesNames.pageNameNewTitle') }}</a>
            <a href="https://juliaallert.com/en/sale" class="butt">{{ trans('vars.General.gotoOutlet') }}</a>
        </div>
        <p class="ignore">
        ...
        <div class="logo2"></div>
        <ul class="info">
            <li><a href="https://juliaallert.com">Julia Allert</a></li>
