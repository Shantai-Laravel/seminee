...
function getParamImages($productId, $paramId)
{
    $prodParamVals = \App\Models\ParameterValueProduct::where('product_id', $productId)->where('parameter_id', $paramId)->pluck('parameter_value_id')->toArray();

    return \App\Models\ParameterValue::whereIn('id', $prodParamVals)->where('image', '!=', '')->get();
}
